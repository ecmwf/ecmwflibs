...
DEFAULT_DOCKCROSS_IMAGE=ecmwflibs-build-mxe:latest
...
# build-ecmwflibs:latest image, run:
#
# docker run --rm build-ecmwflibs:latest > dockcross-manylinux2014-x64-latest
# chmod +x dockcross-manylinux2014-x64-latest
#
